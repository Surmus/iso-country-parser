...
|id=XXX data-sort-value=XXX colspan=8|{{flagicon|Country without code}}&nbsp;[[Country without code|code is not here]] – See [[#XXX|Other country, somrthing]]. |-style="background-color:white;" 
|id=AZER|{{flagicon|Azerbaijan}}&nbsp;[[Azerbaijan]] |[[Azerbaijan|The Republic of Azerbaijan]] |align=center|UN member state |align=center|[[ISO 3166-1 alpha-2#AZ|{{mono|AZ}}]] |align=center|[[ISO 3166-1 alpha-3#AZE|{{mono|AZE}}]] |align=center|[[ISO 3166-1 numeric#031|{{mono|031}}]] |align=center|[[ISO 3166-2:AZ]] |align=center|[[.az]] |-style="background-color:white;`
